                ...
                <div class="col-10 post-page-comment pt-3 pb-2 px-3 mt-2">
                    <div class="row px-2 py-0">
                        <div class="col-auto p-0 m-0">
                            ...
                            <div class="col-auto p-0 m-0 ms-auto">
                                <span class="comment_id" hidden>` + comment['comment']['id'].toString() + `</span>` +
                    ...
                    <div class="row align-items-end px-2 py-1">
                        ...
                        <div class="col-lg-auto col-12 px-0 py-1 m-0 align-self-end ms-auto">
                            <div class="row">
                                <div class="d-flex">
                                    <h3 class="post-page-comment-interactions pe-3 my-0">` + comment['likes'].toString() + ` <i title="Like comment" class="far fa-thumbs-up"></i></h3>
                                    <h3 class="post-page-comment-interactions pe-3 my-0">` + comment['dislikes'].toString() + ` <i title="Dislike comment" class="far fa-thumbs-down"></i></h3>
                                    <i title="Report comment" class="fas fa-ban my-0 pe-3 post-page-report-comment"></i>
                                    <h3 class="post-page-comment-interactions my-0">` + comment['thread_count'].toString() + ` <i class="far fa-comments"></i></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-11 post-page-comment-reply reply py-2 pt-2 pb-1 mt-1">
                            ...
                            <div class="row align-items-end px-2 py-0">
                                ...
                                <div class="col-lg-auto col-12 px-0 py-1 m-0 align-self-end ms-auto">
                                    <div class="row">
                                        <div class="d-flex">
                                            <h3 class="post-page-comment-interactions pe-3 my-0">` + thread['likes'].toString() + ` <i title="Like comment" class="far fa-thumbs-up"></i></h3>
                                            <h3 class="post-page-comment-interactions pe-3 my-0">` + thread['dislikes'].toString() + ` <i title="Dislike comment" class="far fa-thumbs-down"></i></h3>
                ...
                <div class="col-10 mx-0 px-0">
                    <div class="row justify-content-end comment-replies mx-0 px-0">
                        <div class="col-11 post-page-comment-reply-editor px-0 mx-0 mt-1">
                            ...
                            <div class="row px-0 mx-0 justify-content-end">
                                <div class="col-auto px-0">
                                    <span class="thread_comment_id" hidden>` + comment['comment']['id'].toString() +`</span>
            ...
            <div class="col-10 mx-0 px-0">
                <div class="row justify-content-end comment-replies mx-0 px-0">
                    <div class="col-11 post-page-comment-reply reply py-2 pt-2 pb-1 mt-1">
                        ...
                        <div class="row align-items-end px-2 py-0">
                            <div class="col-lg-auto col-12 px-0 py-1 m-0 align-self-end">
                                <h3 class="post-page-comment-reply-author-date p-0 m-0">by <a href="+/userprofile+php">` + comment['author'] + `</a>, ` + comment['date'] + `</h3>
                            </div>
                            <div class="col-lg-auto col-12 px-0 py-1 m-0 align-self-end ms-auto">
                                <div class="row">
                                    <div class="d-flex">
