                    ...
                    <div class="col-10">
                        <div class="row px-0 mx-0">
                            ...
                            <div class="col-lg-7 col-12 form-group spoiler-checkbox p-1 mt-1 mb-0 pb-0 align-self-end">
                                <input type="checkbox" id="spoiler" name="spoiler-checkbox" value="{{$post->spoiler}}">
                    ...
                    <div class="col-10">
                        <div class="row d-flex flex-row">
                            ...
                            <div class="col-md-auto col-12 text-center">
                                <button type="button" id="edit-post-cancel-button" class="btn cancel-post">Cancel</button>
                            </div>
