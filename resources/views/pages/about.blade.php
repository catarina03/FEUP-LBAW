...
@section('content')
    <div class="container about-us-card" style="margin-bottom: 5em;margin-top:4em;">
        <div class="row text-left about-rounded justify-content-center pb-0"
            ...
            <div class="col-lg-9 col-11">
                ...
                <div class="card" style="background-color:#8ab5b1;border:none;">
                    <div class="card-body about-us">
                        ...
                        <p style="margin-top:0.5em;"> Any violation to the above rules can be reported, analyzed and
                            deleted
                            by the platform's
                            moderators.</p>
                    </div>
