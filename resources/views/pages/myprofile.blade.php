                                ...
                                <form action="#" method="post" data-toggle="tooltip" data-placement="bottom"
                                    ...
                                    <div class="form-group">
                                        <label for="avatar" class="position-absolute d-inline corner-icons"
                                               style="transform:translate(-3em, 14em);">
                            ...
                            <div class="card card-profile col-lg-12 col-xl-12 col-sm-9 mb-5 pb-5"
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="row position-relative" data-toggle="tooltip"
                                                ...
                                                <div class="row card-body bio ">
                                                    <div class="col-12  text-center d-flex">
                                                        I am a senior editor and specialized in covering the evolution
                                                        and
                                                        impact of
                                                        brands. Bidibodibi
                                                    </div>
                                        ...
                                        <form action="#" method="post" class=" col-lg-12 position-relative ">
                                            <div class="row position-relative d-none  justify-content-center bio-form">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                    ...
                                                    <button type="submit"
                                                            class="btn btn-sm col-2 me-2 mt-1 my-profile-features save-button save-form">
                                                        Save
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="justify-content-center d-flex ">
                                        ...
                                        <div class="d-inline p-2"><a href="#" class="my-profile-features ">Saved
                                                Posts</a>
                                        </div>
