                ...
                @auth
                    ...
                    @else
                        <div class="post-page-save-post-bookmark savePost">
                            <i class="bi bi-bookmark-plus-fill" title="Save/unsave post"
                               style="font-size:3em; cursor:pointer;"></i>
                        </div>
                    @endif
                @endauth
                    ...
                    <div class="row align-items-end px-2 py-1">
                        <div class="col-lg-auto col-12 px-0 py-1 m-0 align-self-end">
                            <h3 class="post-page-comment-author-date p-0 m-0">by <a
                                    href="{{route('profile',['id'=>$comment['comment']['user_id']])}}">{{$comment['author']}}</a>, {{$comment['date']}}</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="d-flex">
                                    <h3 class="post-page-comment-interactions pe-3 my-0">{{$comment['likes']}} <i
                                            title="Like comment" class="far fa-thumbs-up XD"></i></h3>
                                    ...
                                    @if($user_id != $comment['comment']->user_id)
                                        <i title="Report comment"
                                           class="fas fa-ban my-0 post-page-report-comment pe-3"></i>
                                    @endif
                                    ...
                                    <div class="row align-items-end px-2 py-0">
                                        <div class="col-lg-auto col-12 px-0 py-1 m-0 align-self-end">
                                            <h3 class="post-page-comment-reply-author-date p-0 m-0">by <a
                                                    href="{{route('profile',['id'=>$thread['comment']['user_id']])}}">{{$thread['author']}}</a>, {{$thread['date']}}</h3>
                                        </div>
                                        <div class="col-lg-auto col-12 px-0 py-1 m-0 align-self-end ms-auto">
                                            <div class="row">
                                                <div class="d-flex">
                                                    <h3 class="post-page-comment-interactions pe-3 my-0">{{$thread['likes']}} <i
                                                            title="Like comment" class="far fa-thumbs-up"></i></h3>
                                                    <h3 class="post-page-comment-interactions pe-3 my-0">{{$thread['dislikes']}} <i
                                                            title="Dislike comment" class="far fa-thumbs-down"></i></h3>
                                                    @if($user_id != $thread['comment']->user_id)
                                                        <i title="Report comment"
                                                           class="fas fa-ban my-0 post-page-report-comment"></i>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
