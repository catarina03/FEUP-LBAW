                ...
                <div class="col-lg-9 col-11 mb-4">
                    ...
                    <div class="row pb-4">
                        <div class="w-100 question-col">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Please, tell us more about your
                                    problem:</label>
                                <textarea class="form-control mt-2" id="support-text" rows="3"
                                          placeholder="Briefly describe your problem here" style="resize:none;"
                                          required></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pb-4 justify-content-center">
                        <div class="col-lg-4 col-sm-12 rate-col">
                            <p class="sm-paragraph d-md-none d-lg-none" style="text-center;padding-left:30%;"> Not
                                much </p>
                        ...
                        <div class="col-lg-4 col-sm-12 rate-col-radio">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input inner faq-i" type="radio" name="inlineRadioOptions"
                                       id="opt1"
