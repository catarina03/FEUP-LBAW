...
@section('content')
    <div class="createPost row g-0 pt-lg-5 pt-3" style="margin-top: 4em; margin-bottom: 7em;">
        ...
        <div class="createPost-center col-12 col-lg-7">
            <div class="card create-post-page-post-card d-flex justify-content-center pt-5 pb-5"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <div class="form-group post-comment-input mb-4">
                                ...
                                <input class="container form-control w-100" id="title" name="title"
                                       value="{{ old('title') }}">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row px-0 mx-0">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12 form-group category-dropdown mt-lg-3 pt-lg-3 p-1">
                                    <select class="form-select" id="category" name="category"
                                            value="{{ old('category') }}" style="cursor:pointer;">
                                ...
                                <div
                                    ...
                                    <input type="checkbox" id="spoiler" name="is_spoiler"
                                           value="{{ old('is_spoiler') }}">
                    ...
                    <div class="container mx-0 px-0 mt-3 create-post-editor-container">
                        <div class="row justify-content-center">
                            <div class="col-10">
                                ...
                                <textarea id="mytextarea" class="create-post-editor col-auto" name="content"
                                          value="{{ old('content') }}" rows="15"
                        ...
                        <div class="col-10">
                            <div class="row d-flex flex-row">
                                ...
                                <div class="col-md-auto col-12 text-center">
                                    <button type="button" id="create-post-cancel-button" class="btn cancel-post">
                                        Cancel
                                    </button>
                                </div>
                                ...
                                <div class="col-md-auto col-12 text-center">
                                    <button type="submit" id="submit-button" class="btn publish-post px-5">Publish
                                    </button>
                                </div>
                            </div>
                        </div>
