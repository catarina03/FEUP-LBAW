        ...
        <div class="row justify-content-start profile settings g-0 mt-4">
            ...
            <div class="col-lg-6 col-12 m-lg-0 mx-auto">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="url" class="form-control" id="twitter"
                                   placeholder="Add Twitter to your profile">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="url" class="form-control" id="facebook"
                                   placeholder="Add Facebook to your profile">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="url" class="form-control" id="linkedin"
                                   placeholder="Add Linkedin to your profile">
                        </div>
                    </div>
                ...
                <div class="row mb-3 justify-content-start ms-lg-5 justify-content-center">
                    <a class="btn btn-danger btn-sm edit-account ps-5 pe-5"
                       style="width:fit-content;height:fit-content;" data-bs-toggle="modal" data-bs-target="#confirm">Delete
                        Account</a>
