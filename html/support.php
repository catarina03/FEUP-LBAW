    ...
    <section class="text-left faq-rounded" style="background-color:#8ab5b1;">
        ...
        <div class="faq_questions">
            ...
            <div class="row px-5 py-3 justify-content-center">
                ...
                <div class="col-lg-4 col-sm-12 rate-col">
                    <p class="sm-paragraph-2 d-md-none d-lg-none" style="text-center;padding-left:30%;"> Very Negatively
                    </p>
                    <p class="md-paragraph-2"> Very Negatively </p>
                </div>
            </div>
            <div class="row px-5 py-3 justify-content-center">
                <a href="homepage.php" style="width:fit-content;" class="btn btn-primary pdash-button" type="button">Submit</a>
            </div>
        </div>
    </section>
</div>
