                ...
                <div class="row mt-5 mb-5">
                    <div class="card post-page-post-card justify-content-center pb-5" style="border-radius:5px;">
                        ...
                        <div class="container-fluid d-flex col-10 justify-content-left mt-1">
                            <h2 class="post-page-post-author-date">by <a href="./user-profile.php">Ana Sousa</a>, FEBRUARY 23, 2021</h2>
                        </div>
                        ...
                        <div class="container-fluid d-flex col-10 justify-content-left mt-2">
                            <p class="post-page-post-text">Mick Jagger narrates a new film on London’s Royal Alberts Hall in celebration
                        ...
                        <div class="container-fluid d-flex col-10 justify-content-center mt-3">
                            <button class="post-page-post-thumbs-up-button btn m-2"><i class="far fa-thumbs-up m-0"></i></button>
                            <button class="post-page-post-thumbs-down-button btn m-2"><i class="far fa-thumbs-down m-0"></i> </button>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-10 post-page-comment py-3 px-3 mt-1">
                                ...
                                <div class="row">
                                    <h4 class="post-page-comment-author-date">by <a href="./user-profile.php">João Santos</a>, FEBRUARY 23,
                                        2021</h3>
                                </div>
                                <div class="row pt-2">
                                    <div class="d-flex">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-10 post-page-comment py-3 px-3 mt-1">
                                ...
                                <div class="row">
                                    <h4 class="post-page-comment-author-date">by <a href="./user-profile.php">Joyce Rodrigues</a>, FEBRUARY 22,
                                        2021</h3>
                                </div>
                                <div class="row pt-2">
                                    <div class="d-flex">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-10 post-page-comment py-3 px-3 mt-1">
                                ...
                                <div class="row">
                                    <h4 class="post-page-comment-author-date">by <a href="./user-profile.php">Beatrice Layne</a>, FEBRUARY 21,
                                        2021</h3>
                                </div>
                                <div class="row pt-2">
                                    <div class="d-flex">
                            ...
                            <div class="col-10 mx-0 px-0">
                                <div class="row justify-content-end comment-replies mx-0 px-0">
                                    <div class="col-12 post-page-comment-reply reply py-3 px-3">
                                        ...
                                        <div class="row">
                                            <h4 class="post-page-comment-author-date">by <a href="./user-profile.php">John Doe</a>, FEBRUARY
                                                21, 2021</h3>
                                        </div>
                                        <div class="row pt-2">
                                            <div class="d-flex">
