                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Green Day Offers Up Punk-Inspired Aerobics in ‘Here Comes the Shock'
                            Video </h5>
                        <small class="text-muted">by <a id="authorName" href="userprofile.php">João Santos</a>,
            ...
            <div class="col-12 col-md-6 col-xl-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <small class="text-muted">by <a id="authorName" href="userprofile.php">Ana Sousa</a>,
